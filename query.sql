...
describe usuario
insert into usuario (Email, Password, Username) values
('admin@cenagas.gob.mx', '123','admin')

insert into usuario (Nombre, Paterno, Materno, Email, Password, Username, titulo, observaciones)
values 
('Jose','Luis','Esparza', 'joselp@cenagas.gob.mx', '123','joselp','Ingeniero','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
('Jose','Luis', 'Razo', 'joselr@cenagas.gob.mx', '123','joselr', 'Ing.','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
('Rodrigo','Espinoza', 'Lara', 'rodrigoel@cenagas.gob.mx', '123','rodrigoel', 'Ingeniero','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
('Jessica','Ortíz','Ochoterena', 'jessicaoo@cenagas.gob.mx','123','jessicaoo', 'ing.','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes')
/*, falta correo y contraseña
    ('Laura','Valencia','Salas','Ingeniero','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
    ('Evelyn','Mendoza','Licona','Ing.','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
    ('Salvador','Blancas','Guzmaán','Ingeniero','Tiene más de 15 años dentro de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
    ('Agustin','Castillo','Mendieta','Ingeniero','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
    ('Ingrid','Valadez','Pastrana','ing.','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
    ('María Eugenia','Madrigal','Posadas','Ing.','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
    ('Sandra','Cuevas','Rojas','Ing.','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
    ('Ulises','Portilla','Saldivar','Ingeniero','Tiene más de 15 años dentro de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
    ('Juan Carlos','Estrada','Peralta','Ingeniero','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
    ('Sergio','Ochoterena','Solís','ing.','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
    ('Miguel Ángel','Rueda','Cervantes','Ing.','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes'),
    ('Verónica','Verona','Petras','Ing.','Tiene más de 15 años dentreo de la empresa CENEGAS y es una persona de mucha confinza ya que ha logrado darle estructura a todos los servicios que han tenido problema so incenvenientes') 
    */
;
select * from usuario
...
describe asignacion
insert into asignacion(Id_Asignacion,Id_Usuario,Id_Proyecto,Id_Residencia,Fecha_alta,Fecha_baja,Funcion)
values
(1000,1,100,1,'20220101','20220301','lider de equipo verificador'),
(1001,2,100,1,'20220101','20220301','suplente'),
(1002,3,100,1,'20220101','20220301','responsable del prearranque'),
(1003,4,101,1,'20220401','20220728','lider de equipo verificador')/*,
...
values
(1000,100,5,1000,1,'Solicitud de cambio','1.1 El "Proponente del Cambio"  inicia el proceso de Administración  de Cambios  (ADC) mediante el Anexo 1. Propuesta y Análisis de Cambio, PRO-CEN-UTA-020-F01. Numerales 1 y 2 (6.1)
