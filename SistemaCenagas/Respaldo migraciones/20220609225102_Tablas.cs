    ...
    public partial class Tablas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "PreArranque",
                column: "Id_ResponsablePreArranque"
                );
            migrationBuilder.CreateIndex(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                      name: "FK_PreArranque_Equipo_Verificador",
                      column: x => x.Id_PreArranque,
                      principalTable: "PreArranque",
                      principalColumn: "Id",
                      onDelete: ReferentialAction.SetNull
                ...
                .Annotation("MySql:CharSet", "utf8mb4");
            migrationBuilder.CreateIndex(
               name: "Index_PreArranque_Equipo_Verificador",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                      name: "FK_Equipo_Verificador__PreArranque_Equipo_Verificador_Integrantes",
                ...
                .Annotation("MySql:CharSet", "utf8mb4");
            migrationBuilder.CreateIndex(
               name: "Index_Equipo_Verificador__PreArranque_Equipo_Verificador_Integrantes",
               table: "PreArranque_Equipo_Verificador_Integrantes",
               column: "Id_Equipo_Verificador"
               );
            migrationBuilder.CreateIndex(
              name: "Index_Usuario__PreArranque_Equipo_Verificador_Integrantes",
              table: "PreArranque_Equipo_Verificador_Integrantes",
              column: "Id_Usuario"
              );
