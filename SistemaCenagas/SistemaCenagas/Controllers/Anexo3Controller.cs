...
{
    public class Anexo3Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public Anexo3Controller(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create(Model_Anexo3EquipoVerificador anexo3_model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    Id_ADC = Global.anexo1.anexo1.Id_PropuestaCambio,
                    Id_Lider = Global.adc.adc.Id_Lider
                };
                ...
                for (int i = 0; i < anexo3_model.miembros.Count(); i++)
                {
                    if (anexo3_model.miembros[i].Equals("true"))
                    {
                        ...
                        {
                            Id_Equipo_Verificador = ev.Id_Equipo_Verificador,
                ...
                //DOCUMENTACION
                anexo3_model.documentacion = new Anexo3_Documentacion[30]; //new List<Anexo3_Documentacion>();
                for(int i = 1; i <= 30; i++)
                {
                    anexo3_model.documentacion[i-1] = (new Anexo3_Documentacion
                    {
                        Id_Anexo3 = anexo3_model.anexo3.Id_Anexo3,
                        Id_Tipo = i,
                        Check = "false",
                        Id_Responsable = Global.adc.adc.Id_Lider
                    });
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            int idEV = _context.ADC_Equipo_Verificador.Where(e => e.Id_ADC == id).FirstOrDefault().Id_Equipo_Verificador;

            var equipoVerificador = Consultas.VistaEquipoVerificador(_context, idEV);

            Model_Anexo3EquipoVerificador model = new Model_Anexo3EquipoVerificador();
            model.anexo3 = _context.Anexo3.Where(a => a.Id_Anexo1 == id).OrderBy(a => a.Id_Anexo3).LastOrDefault();
            ...
            for (int i = 0; i < Global.vista_usuarios.Count(); i++)
            {
                ...
                {
                    if (Global.vista_usuarios.ElementAt(i).user.Id_Usuario == equipoVerificador.ElementAt(j).integrante.Id_Usuario &&
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Model_Anexo3EquipoVerificador model)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    for (int i = 0; i < model.miembros.Count(); i++)
                    {
                        ADC_Equipo_Verificador_Integrantes integrante = _context.ADC_Equipo_Verificador_Integrantes
                            .Where(e => e.Id_Equipo_Verificador == idEV && e.Id_Usuario == model.idMiembro[i]).FirstOrDefault();
                ...
                {
                    if (!Anexo3Exists(model.anexo3.Id_Anexo3))
                    {
                        return NotFound();
                    }
                    else
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit2(int id, Model_Anexo3EquipoVerificador model)
        {
            //return Content(JsonConvert.SerializeObject(proyectos));
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit3(int id, Model_Anexo3EquipoVerificador model)
        {
            //return Content(JsonConvert.SerializeObject(proyectos));
        ...
        public async Task<IActionResult> Edit4(int? id)
        {
            ...
            Global.anexo3_CatalogoTipoDocumentacion = _context.Anexo3_CatalogoTipoDocumentacion.ToList();

            var documentacion = _context.Anexo3_Documentacion.Where(a => a.Id_Anexo3 == model.anexo3.Id_Anexo3).ToList();
            model.documentacion = new Anexo3_Documentacion[30];
            for(int i = 0; i < 30; i++)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit4(int id, Model_Anexo3EquipoVerificador model)
        {
            //return Content(JsonConvert.SerializeObject(proyectos));
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    foreach(var doc in documentacion)
                    {
                        ...
                        doc.Id_Responsable = Global.session_usuario.user.Id_Usuario;
                        _context.Update(doc);
                        i++;
                    }
        ...
        {
            return _context.Anexo3.Any(e => e.Id_Anexo3 == id);
        }
    }
}
