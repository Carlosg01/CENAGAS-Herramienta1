...
namespace SistemaCenagas.Controllers
{
    public class ADC_ProcesosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Proceso,Id_Actividad,Id_ADC,Avance,Faltante_Comentarios,Plan_Accion")] ADC_Procesos aDC_Procesos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Proceso,Id_Actividad,Id_ADC,Avance,Faltante_Comentarios,Plan_Accion")] ADC_Procesos aDC_Procesos)
        {
