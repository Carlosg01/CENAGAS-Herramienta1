...
{
    public class Anexo1_SolicitudesResponsableADCController : Controller
    {
        private readonly ApplicationDbContext _context;

        public Anexo1_SolicitudesResponsableADCController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: Anexo1_SolicitudesResponsableADC
        public async Task<IActionResult> Index()
        {
            Global.vistaAnexo1 = (from a in _context.Anexo1_PropuestaCambio
                                  ...
                                  where a.Id_Proyecto == Global.proyecto.Id_Proyecto &&
                                        a.Id_ResponsableADC == Global.usuario.Id_Usuario
        ...
        // GET: Anexo1_SolicitudesResponsableADC/Details/5
        ...
        // GET: Anexo1_SolicitudesResponsableADC/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Anexo1_SolicitudesResponsableADC/Create
        ...
        // GET: Anexo1_SolicitudesResponsableADC/Edit/5
        ...
        // POST: Anexo1_SolicitudesResponsableADC/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Anexo1_SolicitudesResponsableADC/Delete/5
        ...
        // POST: Anexo1_SolicitudesResponsableADC/Delete/5
