...
namespace SistemaCenagas.Controllers
{
    ...
    public class SistemasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var model = _context.Sistema.ToList();
        ...
        global = JsonConvert.DeserializeObject<Global>(HttpContext.Session.GetString("Global"));   
            ...
            var model = await _context.Sistema
        ...
        public async Task<IActionResult> Create(Sistema model)
        {
            global = JsonConvert.DeserializeObject<Global>(HttpContext.Session.GetString("Global"));
            //HttpContext.Session.SetString("Global", JsonConvert.SerializeObject(global));//
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var model = await _context.Sistema.FindAsync(id);
            if (model == null)
            {
                HttpContext.Session.SetString("Global", JsonConvert.SerializeObject(global));
                ViewBag.global = global;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Sistema model)
        {
            global = JsonConvert.DeserializeObject<Global>(HttpContext.Session.GetString("Global"));
            if (id != model.Id)
            {
        ...
        {
            global = JsonConvert.DeserializeObject<Global>(HttpContext.Session.GetString("Global"));
            var usuario = await _context.Sistema.FindAsync(id);
            usuario.Eliminado = 0;
            _context.Sistema.Update(usuario);
            await _context.SaveChangesAsync();
            HttpContext.Session.SetString("Global", JsonConvert.SerializeObject(global));
            ViewBag.global = global;
