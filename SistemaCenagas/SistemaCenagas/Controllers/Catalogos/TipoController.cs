...
namespace SistemaCenagas.Controllers
{
    public class TipoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var model = _context.Tipo.ToList();
        ...
        public async Task<IActionResult> Create(Tipo model)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var model = await _context.Tipo.FindAsync(id);
            if (model == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, Tipo model)
        {
            if (id != model.Id)
            {
                return NotFound();
        ...
        {
            var usuario = await _context.Tipo.FindAsync(id);
            usuario.Eliminado = 0;
            _context.Tipo.Update(usuario);
            await _context.SaveChangesAsync();
