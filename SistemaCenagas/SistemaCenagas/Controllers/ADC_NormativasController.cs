    ...
    public class ADC_NormativasController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            Global.normativas = Global.vista_normativas.Where(
                n => n.adc_normativas.Id_Normativa == id).FirstOrDefault();
        ...
        {
            int num_normativas = _context.ADC_Normativas.Where(n => n.Id_Actividad == Global.actividadADC.Id_Actividad)
                .Count() + 1;
            ViewBag.clave_normativa = Global.actividadADC.Id_Actividad.ToString() + "." + num_normativas.ToString();
